...
template <class T> void linked_list<T>::insert(T element){
...
template <class T> void linked_list<T>::insertAtHead(T element){
	Node *newNode = new Node ;
	newNode->value = element ;
	newNode->next = head ;
	head = newNode ;
...
template <class T> bool linked_list<T>::search(T testcase){
...
template <class T> T linked_list<T>::removeAtHead(){
	Node *temp = head ;
...
template <class T> T linked_list<T>::remove(T getout){
	if(search(getout)){
...
template <class T> T linked_list<T>::removeAtIndex(int index){
	Node *temp = new Node ;
	temp = head ;
...
template <class T> void linked_list<T>::insertAtIndex(T element, int index){
	Node *newNode = new Node ;
	newNode->value = element ;
	Node *temp = new Node ;
	temp = head ;
